...
- 令 $$M_{S_k}=E\left[\left|S_k\right|^2\right]$$；

- 令 $$M_{\hat{S}_k^{(l-1)}}=E\left[\left|\hat{S}_k^{(l-1)}\right|^2\right]$$；

- 令 $$M_W=E\left[\left|W_k\right|^2\right]$$；

- 令 $$r_{S_k, \hat{S}_k^{(l-1)}}=E\left[S_k \hat{S}_k^{(l-1) *}\right]$$；
